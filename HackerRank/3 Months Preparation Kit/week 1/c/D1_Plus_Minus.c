 ...
 * @ Author: Amir W. Fathy
 * @ AKA: darkstar0x714
 * @ Create Time: 2024-12-14 15:37:29
...
void plusMinus(int arr_count, int* arr) {
    float positiveCount=0.0,negtiveCount=0.0,zerosCount=0.0;
    ...
    printf("%f\n%f\n%f",positiveCount/arr_count,negtiveCount/arr_count,zerosCount/arr_count);
}
