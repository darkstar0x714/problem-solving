/**
 * @ Author: Amir W. Fathy
 * @ Create Time: 2023-10-13 18:51:57
...
{
    int mainDialog = 0, secondaryDialog = 0;
    int arrSize = arr.size();
    for (int i = 0; i < arrSize; i++)
    {
        mainDialog = mainDialog + arr[i][i];
        secondaryDialog = secondaryDialog + arr[i][arrSize - 1 - i];
    }
    return abs((mainDialog - secondaryDialog));
}
