...
int main() {
    ...
    vector<string> gmailUsers; // To store the first names of users with Gmail accounts
    ...
    for (int N_itr = 0; N_itr < N; N_itr++) {
        ...
        if (emailID.substr(emailID.find('@') + 1) == "gmail.com") {
            gmailUsers.push_back(firstName);
        }
    }

    // Sort and print the first names of Gmail users
